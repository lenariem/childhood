                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('instagram', 2); ?>" class="footer__social-item" target="_blank">
                            ...
                            <a href="<?php the_field('facebook', 2); ?>" class="footer__social-item" target="_blank">
                            ...
                            <a href="<?php the_field('youtube', 2); ?>" class="footer__social-item" target="_blank">
